...
def main():
    ...
    # Products Creation
    plpmn = Product(id="LP-000", name="Laptop Mini", model="LP-Mn-0", price=0, dimensionX=277, dimensionY=219, dimensionZ=9)
    plpmn.save()
    ...
    plp = Product(id="LP-001", name="Laptop", model="LP-Nm-0", price=0, dimensionX=348, dimensionY=243, dimensionZ=9)
    plp.save()
    ...
    plpmx = Product(id="LP-002", name="Laptop Max", model="LP-Mx-0", price=0, dimensionX=392, dimensionY=259, dimensionZ=9)
    plpmx.save()
    ...
    tbmn = Product(id="TB-000", name="Tablet Mini", model="TB-Mn-0", price=0, dimensionX=135, dimensionY=200, dimensionZ=8.4)
    tbmn.save()
    ...
    tb = Product(id="TB-001", name="Tablet", model="TB-Nm-0", price=0, dimensionX=170, dimensionY=239, dimensionZ=8.4)
    tb.save()
    ...
    tbmx = Product(id="TB-002", name="Tablet Max", model="TB-Mx-0", price=0, dimensionX=186, dimensionY=241, dimensionZ=8.4)
    tbmx.save()
    ...
    pnmn = Product(id="PN-000", name="Phone Mini", model="PN-Mn-0", price=0, dimensionX=64.2, dimensionY=131, dimensionZ=7.4)
    pnmn.save()
    ...
    pn = Product(id="PN-001", name="Phone", model="PN-Nm-0", price=0, dimensionX=71.5, dimensionY=147, dimensionZ=7.4)
    pn.save()
    ...
    pnmx = Product(id="PN-002", name="Phone Max", model="PN-Mx-0", price=0, dimensionX=78.1, dimensionY=161, dimensionZ=7.4)
    pnmx.save()
